...
public class App {
    ...
    public static void editar(Integer id){
        ...
        Aluno aluno = alunos.get(id);
        System.out.println("O nome aluno é: "+aluno.getNome()+" digite 1 para editar:");
        Integer opcao = sc.nextInt();
        if(opcao == 1){
            System.out.println("Digite o novo nome: ");
            aluno.setNome(sc2.nextLine());
        }
        System.out.println("O idade do aluno é: "+aluno.getIdade()+" digite 1 para editar:");
        opcao = sc.nextInt();
        if(opcao == 1){
         ...
         System.out.println("O curso do aluno é: "+aluno.getIdade()+" digite 1 para editar:");
        opcao = sc.nextInt();
        if(opcao == 1){
